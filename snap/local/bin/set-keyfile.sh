...
#
# Usage:
#   _NAME_.set-keyfile KEY
#   _NAME_.get-keyfile | _NAME_.set-keyfile
#
...
Example:
  sudo snap run _NAME_.set-keyfile "$key"
  sudo snap run _NAME_.get-keyfile | sudo snap run _NAME_.set-keyfile
EOF
}
